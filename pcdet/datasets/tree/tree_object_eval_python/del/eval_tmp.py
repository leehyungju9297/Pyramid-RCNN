...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    overlap_0_7 = np.array([[0.7], [0.7], [0.7]]) ## 왜 3개인지 아직 증명이 안되었음. bbox, bev, 3d 일지도...
...
def boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    boxes_a = torch.tensor(boxes_a).cuda()
    boxes_b = torch.tensor(boxes_b).cuda()
...
gt_box = np.array([[-1.0311458e+01,  1.7220247e+01,  2.0355759e+01,  1.0429526e+01,
           9.8209114e+00,  1.2296372e+01,  0.0],
         [-2.0867579e+01,  1.3091569e+01,  1.9900669e+01,  1.1182342e+01,
           1.1029216e+01,  1.1574436e+01,  0.0],
         [ 1.5597132e+00,  2.0848246e+01,  2.1787548e+01,  1.1339691e+01,
           1.0877441e+01,  1.2283292e+01,  0.0]]).astype(np.float64)
dt_box = np.array([[-1.0311458e+01,  1.7220247e+01,  2.0355759e+01,  1.0429526e+01,
           9.8209114e+00,  1.2296372e+01,  0.0],
         [-2.0867579e+01,  1.3091569e+01,  1.9900669e+01,  1.1182342e+01,
           1.1029216e+01,  1.1574436e+01,  0.0],
         [ 1.5597132e+00,  2.0848246e+01,  2.1787548e+01,  1.1339691e+01,
...
gt_box = np.array([[-1.0311458e+01,  1.7220247e+01,  2.0355759e+01,  1.0429526e+01,
           9.8209114e+00,  1.2296372e+01,  9.1783568e-04],
         [-2.0867579e+01,  1.3091569e+01,  1.9900669e+01,  1.1182342e+01,
           1.1029216e+01,  1.1574436e+01,  7.5316639e-04],
         [ 1.5597132e+00,  2.0848246e+01,  2.1787548e+01,  1.1339691e+01,
           1.0877441e+01,  1.2283292e+01,  9.4836584e-04]]).astype(np.float32)
dt_box = np.array([[-1.0311458e+01,  1.7220247e+01,  2.0355759e+01,  1.0429526e+01,
           9.8209114e+00,  1.2296372e+01,  9.1783568e-04],
         [-2.0867579e+01,  1.3091569e+01,  1.9900669e+01,  1.1182342e+01,
           1.1029216e+01,  1.1574436e+01,  7.5316639e-04],
...
st = time.time()
for i in range(100):
    a = d3_box_overlap(gt_box, dt_box, criterion=-1)
print (d3_box_overlap(gt_box, dt_box, criterion=-1), a.shape, time.time()-st)

st = time.time()
for i in range(100) :
    b = boxes_iou3d_gpu(gt_box, dt_box)
print (boxes_iou3d_gpu(gt_box, dt_box), b.shape, time.time()-st)
